...
<qgis styleCategories="Symbology" version="3.4.1-Madeira">
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{f688f491-41e8-4eff-b5a2-84fc63fb5160}">
      <rule filter="&quot;Ansprach&quot; = 'KAN'" key="{acb08189-ed0a-492f-9b3f-ab67bfeea923}" label="Kante" symbol="0"/>
      <rule filter="&quot;Ansprach&quot; = 'BOS'" key="{1ee4d636-aaa2-460c-9d2c-1046a8ca6962}" label="Böschung" symbol="1"/>
    </rules>
    <symbols>
