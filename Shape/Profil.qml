...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.4.1-Madeira">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" enabled="1" locked="0">
          ...
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="3,154,8,255"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontFamily="MS Shell Dlg 2" fieldName=" ' '|| PrNr || ' '" fontLetterSpacing="0" fontStrikeout="0" blendMode="0" textOpacity="1" isExpression="1" previewBkgrdColor="#ffffff" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="8" fontWordSpacing="0" fontWeight="50" namedStyle="Standard" multilineHeight="1" fontItalic="0" useSubstitutions="0" fontCapitals="0" textColor="0,0,0,255" fontSizeUnit="Point">
      ...
      <text-format wrapChar="" multilineAlign="4294967295" rightDirectionSymbol=">" formatNumbers="0" placeDirectionSymbol="0" addDirectionSymbol="0" plussign="0" decimals="3" reverseDirectionSymbol="0" autoWrapLength="0" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1"/>
      <placement distUnits="MM" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" rotationAngle="0" placementFlags="2" placement="2" centroidWhole="0" xOffset="0" dist="0" priority="5" maxCurvedCharAngleIn="25" preserveRotation="1" fitInPolygonOnly="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" quadOffset="4"/>
      <rendering zIndex="0" labelPerPart="0" fontLimitPixelSize="0" obstacleFactor="1" obstacleType="0" fontMinPixelSize="3" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="113" displayAll="1" mergeLines="0" obstacle="1" limitNumLabels="0" upsidedownLabels="2" maxNumLabels="2000" drawLabels="1" scaleMin="0" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
